...
if [ -f /var/www/html/core/config/common.config.php ]; then
	...
	echo "max_execution_time = 600" > /etc/php/7.0/apache2/php.ini
	echo "upload_max_filesize = 1G" >> /etc/php/7.0/apache2/php.ini
	echo "post_max_size = 1G" >> /etc/php/7.0/apache2/php.ini
